...
theOutputDir=file.path(outputDir, "PCA_DualBatch_Structures")
theCompareFile=file.path(compareDir, "PCA_DualBatch_Structures.tsv")
theRandomSeed=314
#myRandomSeed <- 314
#myTestSeed <- 42
theBatchType="TSS"
...
if (!is.null(inputDir))
{
  ...
  PCA_DualBatch_Structures(theData=myData,
                           theTitle="Test PCA",
