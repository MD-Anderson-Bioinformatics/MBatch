...
theOutputDir=file.path(outputDir, "SupervisedClustering_Batches_Structures")
#theCompareFile=file.path(compareDir, "SupervisedClustering_Batches_Structures.tsv")
theRandomSeed=314
#myRandomSeed <- 314
#myTestSeed <- 42
theBatchType="TSS"
